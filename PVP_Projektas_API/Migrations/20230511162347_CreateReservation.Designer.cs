...
namespace PVP_Projektas_API.Migrations
{
    ...
    [Migration("20230511162347_CreateReservation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PVP_Projektas_API.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("GivesUserId")
                        .HasColumnType("int");

                    b.Property<int>("ProductId")
                        .HasColumnType("int");

                    b.Property<int>("TakesUserId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("GivesUserId");

                    b.HasIndex("ProductId");

                    b.HasIndex("TakesUserId");

                    b.ToTable("DbReservations");
                });
            ...
            modelBuilder.Entity("PVP_Projektas_API.Models.UnitType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVP_Projektas_API.Models.Product", b =>
                {
                    b.HasOne("PVP_Projektas_API.Models.Address", "ProductAddress")
                        .WithMany("Products")
                    ...
                    b.HasOne("PVP_Projektas_API.Models.UnitType", "UnitType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("PVP_Projektas_API.Models.Reservation", b =>
                {
                    b.HasOne("PVP_Projektas_API.Models.User", "GivesUser")
                        .WithMany()
                        .HasForeignKey("GivesUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVP_Projektas_API.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVP_Projektas_API.Models.User", "TakesUser")
                        .WithMany()
                        .HasForeignKey("TakesUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GivesUser");

                    b.Navigation("Product");

                    b.Navigation("TakesUser");
                });
